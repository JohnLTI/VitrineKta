...
if (isset($_POST["btCadastrar"])) {
    ...
    if ($conexao->errno == 0) {
        ...
        header("location: ./AdmEditar.php?idcomercio=$linha[idcomercio]");
    } else {
...
<head>
    ...
    <title>VitrineKta | Atualizar Empresa</title>
                ...
                <form method='POST' enctype="multipart/form-data">
                    <div class="item">
                        ...
                        <div class="content-input">
                            ...
                            <div>
                                <center style="margin-top: 15px;"><a href="AdmUser.php" class="btcad"> Voltar</a></center>
                            </div>
                        </div>
                    </div>
                </form>
