                        ...
                        ?>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                                <div class="card" id="card-blog">
                                    <a href="<?php echo $row_linha['link']; ?>" target="_blank">
                                        <img class="card-img-top" src="<?php echo "../../public/uploads/" . $row_linha['imagem_blog']; ?>" alt="Imagem da notícia">
                                    </a>
                                    <div class="card-body d-flex flex-column">
                                        <h4><a href="<?php echo $row_linha['link']; ?>" target="_blank"><?php echo $row_linha['titulo']; ?></a></h4>
                                        <div class="text-muted"><?php echo $row_linha['descricao']; ?></div>
                                        <div class="d-flex align-items-center pt-5 mt-auto">
                                            <div class="avatar avatar-md mr-3">
                                                <img class="card-avatar" src="../../public/uploads/<?php echo $row_linha['imagem'];?>">
                                            </div>
                                            <div>
