<div class="header" id="header-blog">
    <div class="containercabecalho" id="header-cabecalho">
        <nav class="navbar navbar-dark">
            ...
            <div class="final-header">
                ...
                <div class="flexDiv">
                    <button class="sec_btn" onclick="openMulti();"><img src="img/menu.png"></button>
                    <div class="selectWrapper">
                        <div class="multiSelect" id="menu-0">
                            ...
                            {?>
                                <a href="../admin/register.php" class="itens-menu">
                                    <div  class="bottomBorder">Cadastrar</div>
                                </a>
                                <a href="../admin/index.php" class="itens-menu">
                            ...
                            ?>
                                ...
                                <a href="../admin/AdmUser.php?id=<?php echo $id;?>" class="itens-menu">
                                    <div class="bottomBorder">Painel Controle</div>
                                </a>
                            
                            <?php }?>
                            <a href="./blog.php" class="itens-menu">
                                <div>Últimas Notícias</div>
                            </a>
                            <a href="./sobre.php" class="itens-menu">
                                <div>Quem Somos</div>
                            </a>
                            <a href="./parceiros.php" class="itens-menu">
                                <div >Parceiros</div>
                            </a>
                            <a href="./termos de uso.php" class="itens-menu">
                                <div>Termos de Uso</div>
                            </a>
                            <?php  if((isset ($_SESSION['email']) == true) and (isset ($_SESSION['senha']) == true))
                            {?>
                                <a href="../admim/logout.php" class="itens-menu">
